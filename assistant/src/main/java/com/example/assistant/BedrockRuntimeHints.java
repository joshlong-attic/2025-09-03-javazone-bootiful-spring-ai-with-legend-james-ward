...
class BedrockRuntimeHints implements RuntimeHintsRegistrar {
    ...
    private void registerBedrockAgentRuntimeService(RuntimeHints hints, ClassLoader classLoader) {
        String pkg = "software.amazon.awssdk.services.bedrockagentruntime";
     ...
     */
    private void registerBedrockAgentCoreService(RuntimeHints hints, ClassLoader classLoader) {
        String pkg = "software.amazon.awssdk.services.bedrockagentcore";
     ...
     */
    private void registerBedrockAgentCoreControlService(RuntimeHints hints, ClassLoader classLoader) {
     ...
     */
    private void registerBedrockDataAutomationService(RuntimeHints hints, ClassLoader classLoader) {
        String pkg = "software.amazon.awssdk.services.bedrockdataautomation";
        register(hints, classLoader, pkg + ".BedrockDataAutomationClient");
        register(hints, classLoader, pkg + ".BedrockDataAutomationAsyncClient");

        String modelPkg = pkg + ".model";
        register(hints, classLoader, modelPkg + ".CreateDataAutomationProjectRequest");
        register(hints, classLoader, modelPkg + ".CreateDataAutomationProjectResponse");
        register(hints, classLoader, modelPkg + ".GetDataAutomationProjectRequest");
        register(hints, classLoader, modelPkg + ".GetDataAutomationProjectResponse");
    }

    /**
     * Register Bedrock Data Automation Runtime service classes
     */
    private void registerBedrockDataAutomationRuntimeService(RuntimeHints hints, ClassLoader classLoader) {
        String pkg = "software.amazon.awssdk.services.bedrockdataautomationruntime";
        register(hints, classLoader, pkg + ".BedrockDataAutomationRuntimeClient");
        register(hints, classLoader, pkg + ".BedrockDataAutomationRuntimeAsyncClient");

        String modelPkg = pkg + ".model";
        register(hints, classLoader, modelPkg + ".InvokeDataAutomationRequest");
        register(hints, classLoader, modelPkg + ".InvokeDataAutomationResponse");
    }

    /**
     * Register serialization support classes
     */
    private void registerSerializationClasses(RuntimeHints hints, ClassLoader classLoader) {
        // Core SDK serializable classes
        register(hints, classLoader, "software.amazon.awssdk.core.SdkBytes");
        register(hints, classLoader, "software.amazon.awssdk.core.SdkNumber");
        register(hints, classLoader, "software.amazon.awssdk.core.util.DefaultSdkAutoConstructList");
        register(hints, classLoader, "software.amazon.awssdk.core.util.DefaultSdkAutoConstructMap");
        register(hints, classLoader, "software.amazon.awssdk.awscore.exception.AwsErrorDetails");
        register(hints, classLoader, "software.amazon.awssdk.http.DefaultSdkHttpFullResponse");

        // Register for Java serialization
        hints.serialization().registerType(TypeReference.of("software.amazon.awssdk.core.SdkBytes"));
        hints.serialization().registerType(TypeReference.of("software.amazon.awssdk.core.SdkNumber"));
        hints.serialization().registerType(TypeReference.of("software.amazon.awssdk.awscore.exception.AwsErrorDetails"));
    }
    ...
    private void registerResources(RuntimeHints hints) {
        ...
        hints.resources().registerPattern("software/amazon/awssdk/services/bedrock*/codegen-resources/endpoint-rule-set.json");
        hints.resources().registerPattern("software/amazon/awssdk/services/bedrock*/codegen-resources/paginators-1.json");
    ...
    private void register(RuntimeHints hints, ClassLoader classLoader, String className) {
        try {
            ...
            // Also register Builder inner class if present
            tryRegisterInnerClass(hints, classLoader, className + "$Builder");
            tryRegisterInnerClass(hints, classLoader, className + "$SerializableBuilder");

        }//
        catch (ClassNotFoundException e) {
            // Class not found - this is expected for some optional classes
        }
    }

    /**
     * Try to register an inner class
     */
    private void tryRegisterInnerClass(RuntimeHints hints, ClassLoader classLoader, String className) {
        try {
            Class<?> clazz = Class.forName(className, false, classLoader);
            hints.reflection().registerType(TypeReference.of(clazz), ALL_CATEGORIES);
        } catch (ClassNotFoundException e) {
            // Inner class doesn't exist, that's okay
        }
    }
}
